...
class NoticeService {
  ...
  static const Map<String, String> _versionReleaseNotes = {
    '0.1.22': '''📢 v0.1.22 기형 렌더링(1, 2, 3 쏠림) 영구 박멸!

선생님, 모든 미스터리가 풀렸습니다! 
앱 화면에 1, 2, 3이 쏠려있고 띄어쓰기가 박살 난 쓰레기 텍스트가 튀어나왔던 것은, PDF 파서가 표(Table)를 멍청하게 세로로 읽어버렸기 때문입니다.
당연히 우리는 이 쓰레기를 없애고자 예전에 "완벽하게 수제작한 JSON 문제 파일"을 덮어씌우도록 설계했으나... 식별 번호가 서로 불일치(1_internal_1 vs s1_pdf_1)하여 덮어씌워지지 못하고, 두 데이터가 앱 속에서 좀비처럼 공존하고 있었습니다!
이제 모든 식별자 규격을 통일하고 깨끗한 DB(v37)로 강제 청소하여, 오직 100% 아름답게 다듬어진 "수제작 데이터"만이 화면에 나오도록 완벽 조치했습니다!''',
